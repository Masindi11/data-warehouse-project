...
==================================================================================
Script purpose:
This stored procedure performs the ETL (Etract, Transform,Load) process to populate the 
...
PRINT '>> Inser Data Into:silver.crm_cust_info';
...
SELECT
 ...
 ELSE CAST(CAST(sls_order_dt AS VARCHAR) AS DATE)      -- chanaging it to a correct data type
 END AS sls_order_dt,
